...
Процедура Печать(Команда)
	...
	ТабДок = ПечатьИзМодуляОбъекта("Исследование");
	ТабДок.Показать();  
...
&НаСервере
Функция ПечатьИзМодуляОбъекта(ТипПечатнойФормы)//для теста
	...
	ПолучСтруктура = ДанныйОбъект.ФормированиеМасОбластей(Объект.СсылкаНаОбъект, ТипПечатнойФормы);
