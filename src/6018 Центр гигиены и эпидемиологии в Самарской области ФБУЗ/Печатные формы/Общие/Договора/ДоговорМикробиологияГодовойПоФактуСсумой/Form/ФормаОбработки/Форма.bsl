...
Функция ФормированиеДоговора(СсылкаДокумент)
	...
	Область31.Параметры.ТекстПункта31 = "3.1. Цена по данному договору определяется в соответствии с Приложением №1, 2 и рассчитывается на основании Прейскуранта цен с 01.01.2016 г. на платные медицинские работы (услуги), выполняемые Исполнителем на основании заявки на виды лабораторных исследований и составляет до " + СуммаЧислоСтрокой + "("+ СуммаПрописью +")" +", в том числе сумма НДС 18%.";
	
	Область32.Параметры.ТекстПункта32 = "3.2. Оплата осуществляется Заказчиком по факту оказания услуг в форме перечисления денежных средств на расчетный счет Исполнителя в течение 10 рабочих дней после получения  документов, подтверждающих оказание услуг в соответствии с настоящим договором и актом оказанных услуг,  согласно выставленному счету. Моментом оплаты за оказанные услуги по настоящему договору считается момент поступления денег на лицевой счет Исполнителя.";
	Область33.Параметры.ТекстПункта33 = "3.3. В случае изменения Прейскуранта Исполнитель информирует Заказчика не позднее, чем в десятидневный срок.";
	...
	|" + "3.6. Источник финансирования настоящего договора_____________________________________________________";
