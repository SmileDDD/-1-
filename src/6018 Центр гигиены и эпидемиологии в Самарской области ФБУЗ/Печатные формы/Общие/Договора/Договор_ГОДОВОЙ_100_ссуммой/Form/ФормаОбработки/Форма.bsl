...
Функция ФормированиеДоговора(СсылкаДокумент)
	...
	Область31.Параметры.ТекстПункта31 = "3.1. Цена договора составляет  " + СуммаЧислоСтрокой + "("+ СуммаПрописью +")" +", в т.ч. НДС 18% " + НДСЧислоСтрокой + " (" +НДСПрописью +")" +", и определяется в соответствии с Приложением №__1,2 действующего  Прейскуранта цен Исполнителя от 01.01.2016г.";
