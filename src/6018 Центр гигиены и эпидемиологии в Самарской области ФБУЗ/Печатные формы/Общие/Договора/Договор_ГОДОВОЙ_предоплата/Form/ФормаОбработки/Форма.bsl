...
Функция ФормированиеДоговора(СсылкаДокумент)
	...
	Область1.Параметры.Пукт12 = "1.2. Наименование услуг и их стоимость указывается в Расчете стоимости  оказанных услуг и является неотъемлемой частью настоящего договора  в виде Приложений";    			
	...
	Область31.Параметры.ТекстПункта31 = "3.1. Цена по данному договору определяется в соответствии с Приложением № " + НомерПунктовПрейскуранта + " действующего  Прейскуранта цен Исполнителя от 01.01.2016г.";
	Область32.Параметры.ТекстПункта32 = "3.2.Оплата осуществляется Заказчиком в форме денежных средств на расчетный счет Исполнителя в порядке " + СсылкаДокумент.Оплата + " предоплаты от суммы выставленного счета. Моментом оплаты за оказанные услуги по настоящему договору считается момент поступления денег в размере " + СсылкаДокумент.Оплата + " предоплаты на лицевой счет Исполнителя. Оставшаяся сумма оплачивается после оказания услуг, в течение 5 банковских дней после получения  документов, подтверждающих оказание услуг, в соответствии с настоящим договором и актом оказанных услуг.";
