...
Функция ФормированиеДоговора(СсылкаДокумент)
	...
	Область53  = Макет.ПолучитьОбласть("Область53");     
	...
	Область1.Параметры.Пукт12 = "1.2. Заказчик получает дозиметры индивидуальной дозиметрии у Исполнителя ежеквартально, в количестве равном количеству персонала, указанного в заявлении Заказчика.  
	|1.3. Наименование услуг и их стоимость указывается в Расчете стоимости оказанных услуг и является неотъемлемой частью настоящего договора в виде Приложений.";
	
	Область31.Параметры.ТекстПункта31 = "3.1. Цена по данному договору определяется в соответствии с Приложением №__1,2 действующего  Прейскуранта цен Исполнителя от 01.01.2016г.";
	Область32.Параметры.ТекстПункта32 = "3.2. Оплата осуществляется Заказчиком в форме перечисления денежных средств на расчетный счет Исполнителя в течение 5 банковских дней после получения  документов, подтверждающих оказание услуг в соответствии с настоящим договором и актом оказанных услуг,  согласно выставленному счету. Моментом оплаты за оказанные услуги по настоящему договору считается момент поступления денег на лицевой счет Исполнителя.";
	...
	Область51.Параметры.ТекстПункта51 = "5.1. Ответственность Сторон за неисполнение или ненадлежащее исполнение обязательств по договору определяется в соответствии с действующим законодательством Российской Федерации.";
	...
	Область53.Параметры.ТекстПункта53 = "5.3. В случае утери или повреждения Заказчиком дозиметров индивидуальной дозиметрии, Заказчик возвращает   Исполнителю новые дозиметры индивидуальной дозиметрии той же модели, в том же количестве взамен утерянных или поврежденных.";
	...
	Область71.Параметры.ТекстПункта71 = "7.1. Договор вступает в силу с момента его подписания Сторонами и действует  до " + Формат(СсылкаДокумент.ДатаОкончания,"ДФ='dd MMMM yyyy'") + " года. Окончание срока действия договора не влечет прекращения обязательств по договору и не освобождает Стороны от ответственности за его нарушение.";
	
	Область72.Параметры.ТекстПункта72 = "7.2.  Срок сдачи услуг по договору: 
	|- в течение 2 месяцев со дня поступления к Исполнителю дозиметров индивидуальной дозиметрии персонала от Заказчика. Дозиметры индивидуальной дозиметрии сдаются Заказчиком на проверку ежеквартально, последние не позднее 31.12.2016 г.";
