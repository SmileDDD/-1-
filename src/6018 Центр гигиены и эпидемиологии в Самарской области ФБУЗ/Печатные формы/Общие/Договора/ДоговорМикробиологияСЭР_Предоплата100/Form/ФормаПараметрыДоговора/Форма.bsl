...
Процедура Ок(Команда)
	...
	Если Не ЗначениеЗаполнено(ФИОРукЗаказчикаРодП) Или 		
		...
		Если Ответ = КодВозвратаДиалога.Да   Тогда
			...
			мСтрукт = Новый Структура("ДолжностьЗаказчика,ОснованиеЗаказчика,ФИОРукЗаказчикаИмПад,ФИОРукЗаказчикаРодП,
			|ИсполнительПодписывающий,ФИОИсполнитель,ФЗ223,ФЗ44,Контракт,ИндДоз ",
			ДолжностьЗаказчика,ОснованиеЗаказчика,ФИОРукЗаказчикаИмПад,ФИОРукЗаказчикаРодП,
			ИсполнительПодписывающий,ФИОИсполнитель,ФЗ223,ФЗ44,Контракт, ИндДоз );
...
Процедура ЗаполнениеРеквизитовФормы()
	...
	Иначе	
		Сообщить(СсылкаНаОбъект.Владелец.Руководитель);
