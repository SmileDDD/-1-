...
Функция ФормированиеДоговора(СсылкаДокумент)
	...
	Область33.Параметры.ТекстПункта33 = "3.3. В случае изменения Размера платы за  санитарно-эпидемиологические  экспертизы, расследования, обследования, исследования, испытания, токсикологические, гигиенические и иные виды оценок, Исполнитель информирует Заказчика не позднее, чем в десятидневный срок.";
