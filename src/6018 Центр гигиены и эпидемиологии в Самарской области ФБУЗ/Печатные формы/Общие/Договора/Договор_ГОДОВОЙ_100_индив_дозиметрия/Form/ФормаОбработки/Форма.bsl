...
Функция ФормированиеДоговора(СсылкаДокумент)
	...
	Область31.Параметры.ТекстПункта31 = "3.1. Цена по данному договору определяется в соответствии с Приложением №__" + НомерПунктовПрейскуранта + " действующего  Прейскуранта цен Исполнителя от 01.01.2016г.";
	...
	Область52.Параметры.ТекстПункта52 = "5.2. В случае утери или повреждения Заказчиком дозиметров индивидуальной дозиметрии, Заказчик возвращает   Исполнителю новые дозиметры индивидуальной дозиметрии той же модели, в том же количестве взамен утерянных или поврежденных.";
