...
Функция ФормированиеДоговора(СсылкаДокумент)
	...
	Область31.Параметры.ТекстПункта31 = "3.1. Цена договора составляет  " + СуммаЧислоСтрокой + "("+ СуммаПрописью +")" +", в т.ч. НДС 18% " + НДСЧислоСтрокой + " (" +НДСПрописью +") " +", и определяется в соответствии с Приказом Исполнителя № 41 от 01.04.2016  «Об утверждении размеров платы за санитарно-эпидемиологические экспертизы, расследования, обследования, исследования, испытания, токсикологические, гигиенические и другие виды оценок».».";
	Область32.Параметры.ТекстПункта32 = "3.2. Оплата осуществляется Заказчиком в форме перечисления денежных средств на расчетный счет Исполнителя в порядке 100% предоплаты согласно выставленному счету. Моментом оплаты за оказанные услуги по настоящему договору считается момент поступления денег на лицевой счет Исполнителя. Исполнитель в течение 5 календарных дней после получения аванса (предоплаты) составляет счет-фактуру на сумму аванса (предоплаты), оформленную в соответствии с п.5.1. ст. 169 Налогового кодекса РФ.";
	Область33.Параметры.ТекстПункта33 = "3.3. В случае изменения Размера платы за  санитарно-эпидемиологические  экспертизы, расследования, обследования, исследования, испытания, токсикологические, гигиенические и иные виды оценок, Исполнитель информирует Заказчика не позднее, чем в десятидневный срок. После внесения 100% предоплаты цена договора изменению не подлежит.";
	...
	// ОбластьЗаголовок.Параметры.ТекстПункта3 = Пункт31;
	...
	Область72.Параметры.ТекстПункта72 = "7.2. Срок оказания услуг по договору – в течение 2 месяцев со дня поступления денег на лицевой счет  Исполнителя.";
