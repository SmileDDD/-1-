...
Функция ФормированиеДоговора(СсылкаДокумент)
	...
	Область32.Параметры.ТекстПункта32 = "3.2.Оплата осуществляется Заказчиком в форме перечисления денежных средств на расчетный счет Исполнителя в порядке " + СсылкаДокумент.Оплата+ " предоплаты от суммы выставленного счета. Моментом оплаты за оказание услуги по настоящему договору считается момент поступления денег в размере " + СсылкаДокумент.Оплата +" предоплаты на лицевой счет Исполнителя. Оставшаяся сумма оплачивается после оказания услуг, в течение 5 банковских дней после получения  документов, подтверждающих оказание услуг, в соответствии с настоящим договором и актом оказанных услуг.";
	...
	Область71.Параметры.ТекстПункта71 = "7.1. Договор вступает в силу с момента его подписания и действует  до полного исполнения всех обязательств сторонами, по данному договору. Окончание срока действия договора не влечет прекращения обязательств по договору и не освобождает стороны от ответственности за его нарушение.";
